...
<title>登录|学生考试管理系统</title>
<meta name="keywords" content="学生考试管理系统">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">学生考试管理系统</h2>
</div>
...
<div class="footer">Copyright &nbsp; HDU @ 李盾 </div>
